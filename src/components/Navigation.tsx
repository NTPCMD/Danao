  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 text-white hover:text-[#C9A961] transition-colors duration-300">
          ...
          <div className="flex items-center gap-8">
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  <span className={isActive ? 'text-[#C9A961]' : 'group-hover:text-[#C9A961] transition-colors duration-300'}>
                    {link.label}
                  </span>
                  <span
                    className={`absolute left-0 -bottom-1 h-0.5 w-full origin-left transform bg-[#C9A961] transition-transform duration-300 ${
                  ...
                  {isActive && (
                    <motion.span
                      layoutId="activeGlow"
                      className="absolute inset-0 -z-10 rounded-full bg-[#C9A961]/10 blur-md"
